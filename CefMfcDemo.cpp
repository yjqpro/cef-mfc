...
ON_COMMAND(ID_APP_ABOUT, &CCefMfcDemoApp::OnAppAbout)
// Standard file based document commands
ON_COMMAND(ID_FILE_NEW, &CWinApp::OnFileNew)
ON_COMMAND(ID_FILE_OPEN, &CWinApp::OnFileOpen)
// Standard print setup command
ON_COMMAND(ID_FILE_PRINT_SETUP, &CWinApp::OnFilePrintSetup)
ON_COMMAND(ID_OPEN_BROWSER, &CCefMfcDemoApp::OnOpenBrowser)
END_MESSAGE_MAP()

// CCefMfcDemoApp construction

CCefMfcDemoApp::CCefMfcDemoApp() noexcept {
...
// The one and only CCefMfcDemoApp object

CCefMfcDemoApp theApp;

// CCefMfcDemoApp initialization
...
BOOL CCefMfcDemoApp::InitInstance() {
  ...
  pDocTemplate = new CSingleDocTemplate(
      IDR_MAINFRAME, RUNTIME_CLASS(CCefMfcDemoDoc),
      RUNTIME_CLASS(CMainFrame),  // main SDI frame window
      RUNTIME_CLASS(CCefMfcDemoView));
  if (!pDocTemplate)
    return FALSE;
...
int CCefMfcDemoApp::ExitInstance() {
...
void CCefMfcDemoApp::InitializeCef() {
...
void CCefMfcDemoApp::UninitializeCef() {
  CefShutdown();
}

// CCefMfcDemoApp message handlers
BOOL CCefMfcDemoApp::PumpMessage()
{
...
void CCefMfcDemoApp::OnAppAbout() {
  CAboutDlg aboutDlg;
  aboutDlg.DoModal();
}
...
void CCefMfcDemoApp::OnOpenBrowser() {
